...
import { Calendar, MapPin, Clock, Play, Globe, Menu as MenuIcon } from "lucide-react"
...
export default function LaFestaDetail({ onNavigate }: LaFestaDetailProps) {
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-end pb-8">
        ...
        <div className="relative z-10 px-4 md:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-light tracking-wider mb-2 italic text-amber-100">LA FESTA</h1>
