    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-end pb-8">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1456926631375-92c8ce872def?w=1200&q=80')`,
          }}
        />
        ...
        <div className="relative z-10 px-4 md:px-8">
          <span className="text-amber-500 text-xs tracking-[0.3em] mb-4 block">SIGNATURE EVENTS</span>
          <h1 className="text-6xl md:text-8xl font-light tracking-wider mb-2 text-white/90" style={{ fontFamily: 'serif' }}>ANIMAL</h1>
          <p className="text-amber-500/80 text-sm tracking-widest mb-8">MÁS SALVAJE. +14 SIN ALCOHOL</p>

          {/* Date and Location */}
          <div className="space-y-3 max-w-xs">
            <div className="flex items-center gap-3">
              <Calendar className="w-4 h-4 text-white/60" />
              <span className="text-white/80 text-sm tracking-wider">SÁBADO 17 DE MAYO</span>
            </div>
            <div className="flex items-start gap-3">
              <MapPin className="w-4 h-4 text-white/60 mt-0.5" />
              <div>
                <span className="text-white/80 text-sm tracking-wider block">DISCOLO NIGHT CLUB</span>
                <span className="text-white/60 text-sm tracking-wider">BARRANQUILLA</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-6 max-w-lg mx-auto">
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] tracking-wider text-white/60 block">FALTAN PARA</span>
              <span className="text-xs tracking-wider text-white">ANIMAL</span>
            </div>
          </div>
      ...
      <section className="px-4 py-6 max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {/* VIP */}
          <div className="border border-amber-500/50 p-4 text-center relative bg-white/5">
            ...
            <h3 className="text-white font-medium tracking-wider text-sm mb-1">MESA VIP 10 PERSONAS</h3>
            <p className="text-white/50 text-[10px] tracking-wider">EXPERIENCIA VIP PARA</p>
            <p className="text-white/40 text-[8px] tracking-wider mb-3">GRUPOS DE 10 PERSONAS</p>
            <div className="mb-1">
      ...
      <section className="px-4 py-6">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=800&q=80')`,
        ...
        >
          ...
          <div className="relative z-10">
            <p className="text-white text-sm tracking-widest mb-4 italic">LOS CUPOS SON LIMITADOS.</p>
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-light tracking-wider mt-1 text-white/90" style={{ fontFamily: 'serif' }}>ANIMAL</h3>
