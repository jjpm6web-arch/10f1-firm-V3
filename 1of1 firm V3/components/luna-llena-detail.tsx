  ...
  return (
    <div className="flex items-center gap-4 md:gap-6">
      <div className="text-center">
        <div className="text-3xl md:text-4xl font-light text-white">{String(timeLeft.days).padStart(2, "0")}</div>
...
export default function LunaLlenaDetail({ onNavigate }: LunaLlenaDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-end pb-8">
        {/* Background Image - Moon with silhouette */}
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1532693322450-2cb5c511067d?w=1200&q=80')`,
          }}
        />
        ...
        <div className="relative z-10 px-4 md:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-light tracking-wider mb-2 italic">LUNA LLENA</h1>
      ...
      <section className="px-4 py-6">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1532693322450-2cb5c511067d?w=800&q=80')`,
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
